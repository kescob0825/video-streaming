...
export async function downloadRawVideo(fileName) {
    ...
    console.log(`gs://${rawVideoBucketName}/${fileName} downloaded to ${rawVideoLocalPath}/${fileName}.`);
}
/**
...
export async function uploadProcessedVideo(fileName) {
    ...
    console.log(`${rawVideoLocalPath}/${fileName} uploaded to gs://${rawVideoBucketName}/${fileName}.`);
...
function deleteFile(filePath) {
    return new Promise((resolve, reject) => {
        if (fs.existsSync(filePath)) {
            ...
            console.log(`File cannot be found at ${filePath}, no deletion were executed.`);
